...
See `water-heating-pumping/screenshots/ladder-logic-overview.png`.
...
(system diagram + 4 ladder-logic screens).
...
finished in the time available. See `robot-sorter/screenshots/ladder-logic-overview.png`.
...
fine-tuned PID and the rocket-engine command sequence. Files: `feedback-control/lab7_base_workspace*.slx`.
